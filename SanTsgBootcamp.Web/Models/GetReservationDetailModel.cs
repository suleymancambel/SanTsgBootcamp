...
{
    public class GetReservationDetailModel
    {
        ...
        public class Message
        {
            ...
            public double messageType { get; set; }
        ...
        public class Reservationinfo
        {
            ...
            public double reservationStatus { get; set; }
            public double confirmationStatus { get; set; }
            ...
            public double paymentFrom { get; set; }
        ...
        {
            public string doubleernationalCode { get; set; }
        ...
        public class Document
        {
            ...
            public double fromToType { get; set; }
        }
        ...
        public class Traveller
        {
            ...
            public double passengerType { get; set; }
        ...
        public class Hoteldetail
        {
            ...
            public double stopSaleGuaranteed { get; set; }
            public double stopSaleStandart { get; set; }
        ...
        {
            public object[] addressLines { get; set; }
        }
